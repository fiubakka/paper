...
\title{
  \mytitlefont \textbf{FIUBAkka} \\ % Título grande
  \large {Juego multijugador online con Akka}    % Descripción en tamaño \large
  }
\date{} % No mostrar fecha en el título
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{../assets/fiubakka-logo.png}
\end{figure}
