...
\begin{titlepage}
    ...
    {\mytitlefont \textbf{FIUBAkka}} % Tamaño y negrita del título
    \vspace{0.5cm}
    ...
    \centering
    \includegraphics[width=0.4\textwidth]{../assets/FIUBAkka-logo-bw.png} % Ajusta la ruta y tamaño de la imagen
    \vspace{1cm}
