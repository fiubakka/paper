...
Llegó un punto donde el cliente empezó a necesitar mas trabajo que el servidor, por lo que la separación en grupos se fue desarmando y
todos desarrollabamos en donde era requerido.
...
múltiples mensajes de protobuf, nos dimos cuenta que ibamos a tener que definir dichos mensajes tanto en el servidor como en el cliente. Eso iba
...
de git, se vería como un directorio y se mantendría igual en ambos proyectos, lo que evitaria el error mencionado anteriormente.
...
luego seria pusheada al repositorio, para no tener que hacer la compilación múltiples veces.
