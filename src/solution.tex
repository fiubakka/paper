...
Todas estas características son exactamente lo que necesitamos para poder comunicar los eventos que los jugadores
realicen dentro del juego. Kafka nos permite implementar un protocolo de comunicación de eventos entre los actores
