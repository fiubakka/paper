...
en cualquier momento, tendríamos que implementar algun proceso que se encargue periódicamente de detener a las entidades cuando no se estén utilizando para liberar los recursos.
...
obtenga tanto el estado incial como realizado la creación de sus correspondientes GameEventProducer y GameEventConsumer, contestará entonces al PlayerHandler el mensaje de \textbf{InitReady}, el cuál completará la sincronización inicial
...
en el que recibó el mensaje de Heartbeat. Adicionalmente, el Player se envía mensajes a sí mismo de forma periódica cada unos 5 segundos donde verifica si la diferencia entre el \textit{timestamp} actual y el almacenado en su estado
